...
function add_css() {
	...
	style.id = "svelte-1t5r9qz-style";
	style.textContent = ".zenzele-tabs__tab.svelte-1t5r9qz{border:none;border-bottom:2px solid transparent;color:#000000;cursor:pointer;max-width:300px;padding:0.5em 0.75em}.zenzele-tabs__tab.svelte-1t5r9qz:focus{outline:thin dotted}.zenzele-tabs__selected.svelte-1t5r9qz{border-bottom:2px solid;color:var(--theme-color)}.titleContent.svelte-1t5r9qz{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}";
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div0 = element("div");
			t = text(/*label*/ ctx[1]);
			attr(div0, "class", "titleContent svelte-1t5r9qz");
			attr(div0, "title", /*label*/ ctx[1]);
			attr(div1, "class", "zenzele-tabs__tab svelte-1t5r9qz");
			set_style(div1, "--theme-color", /*color*/ ctx[2]);
			toggle_class(div1, "zenzele-tabs__selected", /*isSelected*/ ctx[4]);
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$selectedTab, index*/ 33) {
			 $$invalidate(4, isSelected = $selectedTab === index);
		}

		if ($$self.$$.dirty & /*isSelected, element*/ 24) {
			 {
...
class Tab extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1t5r9qz-style")) add_css();
		init(this, options, instance, create_fragment, safe_not_equal, { index: 0, label: 1, color: 2 });
	}
}
...
function add_css$1() {
	var style = element("style");
	style.id = "svelte-1061y9t-style";
	style.textContent = ".zenzele-tabs__tab-list.svelte-1061y9t{margin:0;padding:0;display:flex;flex-direction:row}.zenzele-tabs__navigation.svelte-1061y9t{width:30px;border:0;margin:0px}.zenzele-tabs__center.svelte-1061y9t{display:flex;align-items:center;justify-items:center}.zenzele-tabs__list.svelte-1061y9t{overflow:hidden;flex-grow:2;display:flex}input.svelte-1061y9t:focus{outline:none}";
	append(document.head, style);
}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			input = element("input");
			attr(input, "class", "zenzele-tabs__navigation svelte-1061y9t");
			...
			attr(div, "class", "zenzele-tabs__center svelte-1061y9t");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div, "click", /*prevTab*/ ctx[6]);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div, "click", /*nextTab*/ ctx[5]);
				mounted = true;
			}
		},
		p: noop,
...
function create_fragment$1(ctx) {
	...
	let t1;
	let current;
	let if_block0 = /*visibleArrows*/ ctx[4] && create_if_block_1(ctx);
	...
	let if_block1 = /*visibleArrows*/ ctx[4] && create_if_block(ctx);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function div0_binding($$value) {
		binding_callbacks[$$value ? "unshift" : "push"](() => {
			$$invalidate(2, tabsContainer = $$value);
		});
	}
